...
abstract class $UserInfoModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String email, String name, String? profileImage});
}
...
class _$UserInfoModelImpl implements _UserInfoModel {
  ...
  @override
  String toString() {
    return 'UserInfoModel(id: $id, email: $email, name: $name, profileImage: $profileImage)';
  }
...
abstract class _UserInfoModel implements UserInfoModel {
  const factory _UserInfoModel(
      ...
      final String? profileImage}) = _$UserInfoModelImpl;
